...
from komennot import Summa, Erotus, Nollaus, LaskuKomento
...
class Kayttoliittyma:
    def __init__(self, sovelluslogiikka, root):
        ...
        self._root = root
        self._edellinen_komento: LaskuKomento = None
        self._komennot = {
    ...
    def _kumoa_edellinen(self):
        if (self._edellinen_komento == None):
            return
        self._edellinen_komento.kumoa()
        self._edellinen_komento = None

    def _suorita_komento(self, komento: Komento):
        if (komento == Komento.KUMOA):
            self._kumoa_edellinen()
        else:
